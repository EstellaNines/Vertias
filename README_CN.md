...
#### v0.2.8 - (1-4) - 任务面板的制作、玩家模拟搜索物资过程的制作

##### v0.2.8-4 - 战斗与潜行交互增强 (2025-09-23)

- **✨ 主要功能**：武器射击与子弹限制；潜行/蹲伏重做；右键菜单完整功能
- **🧰 系统**：新增玩家治疗与饱食度恢复
- **🩹 修复**：背包加载乱序；唯一 ID 与状态持久化问题
- **🪧 UI**：右键菜单与状态显示优化；任务系统文本调整

##### v0.2.8-3 - 完整任务系统 (2025-09-17)

- **✨ 主要功能**：完整任务系统上线
- **🧰 系统**：新增物品堆叠系统；装备栏状态同步
- **🩹 修复**：奖励堆叠异常；持久化报错；敌人逻辑视野问题
- **🎞️ 动效**：任务系统动效重置

##### v0.2.8-2 - 完整搜索过程交互 (2025-09-10)

- **✨ 主要功能**：完整搜索过程交互
- **🩹 修复**：背包打开机制问题

##### v0.2.8-1 - 随机物品生成完善 (2025-09-08)

- **✨ 主要功能**：随机物品生成完善
- **🧩 结构**：项目结构调整；统一 ES3 保存机制；任务接受界面 UI 动效
- **🧱 地图**：增加触发区域
- **🪧 UI**：放置提示优化
- **🧹 其他**：小幅调整与清理
