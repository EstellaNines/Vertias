...
- **Awake 阶段**: 加载默认网格配置
- **Start 阶段**: 初始化数据结构和保存系统
- **OnValidate 阶段**: 处理编辑器中的参数变更
...
该算法设计通过三重数据结构的协同工作，实现了高效的网格占用状态管理。在保证查询性能的同时，提供了完整的可视化支持，为 Unity 游戏开发中的网格系统提供了强有力的技术支撑。

---

_文档版本: 1.0_  
_创建日期: 2024 年_  
_适用项目: TPS v0.1-1 Unity 项目_
